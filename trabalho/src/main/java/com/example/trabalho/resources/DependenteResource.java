...
public class DependenteResource {
	...
	@PostMapping
	public ResponseEntity<Dependente> insert(@RequestBody Dependente obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Dependente> update(@PathVariable Long id, @RequestBody Dependente obj){
